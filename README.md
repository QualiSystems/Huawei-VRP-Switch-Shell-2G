...
### Standard version
**Huawei VRP Switch Shell 2G** is based on the Networking Shell Standard version **5.0.4**.
...
Release: **Huawei VRP Switch Shell 2G**
...
#### **Huawei VRP Switch Shell 2G Attributes**
...
|:---|:---|
|Huawei VRP Switch Shell 2G.zip|Device shell package|
|cloudshell-networking-huawei-vrp-offline-deps.zip|Shell Python dependencies (for offline deployments only)|

# Importing and Configuring the Shell
This section describes how to import the **Huawei VRP Switch Shell 2G** shell and configure and modify the shell’s devices.
...
**To create a resource for the device:**
  ...
  2. From the list, select **Huawei VRP Switch Shell 2G**.
